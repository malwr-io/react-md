...
export type OneThumbSliderValue = number;
export type TwoThumbSliderValue = readonly [number, number];
export type SliderValue = OneThumbSliderValue | TwoThumbSliderValue;

export type ReturnedValue<DV extends SliderValue | undefined> = {
  one: OneThumbSliderValue;
  two: TwoThumbSliderValue;
}[DV extends TwoThumbSliderValue ? "two" : "one"];
export type DefaultValue<DV extends SliderValue | undefined> =
  | ReturnedValue<DV>
  | (() => ReturnedValue<DV>);

export interface UseSliderOptions<DV extends SliderValue | undefined>
   ...
   */
  defaultValue?: DefaultValue<DV>;

  mode?: "onDrag" | "onBlur";
  onValueChange?(value: number): void;
}

export interface SliderBehaviorProps<DV extends SliderValue | undefined>
...
// export type UseSliderReturnValue<DV extends SliderValue | undefined> = [
//   SliderBehaviorProps<DV>,
